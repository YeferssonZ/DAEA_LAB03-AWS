...
<?php
  ...
  $api_endpoint = "https://1q9kmqhz-5000.brs.devtunnels.ms/api/";//reemplaze el dominio, por ejemplo http://localhost quedando algo como $api_endpoint = "http://localhost/api/";
  $url = "";
